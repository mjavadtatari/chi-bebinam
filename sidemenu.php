        ...
        <div class="card-body">
            ...
            <div class="card-text">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item chi-list-item"><a href="addmovie.php">افزودن فیلم</a></li>
                    <li class="list-group-item chi-list-item"><a href="watchlist.php">لیست تماشا</a></li>
